<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
	...
	<head>
		...
		<link rel="stylesheet" href="<c:url value ='/common/assets/thong_css/style.css' />">
		<link rel="stylesheet" href="<c:url value ='/common/assets/icons/themify-icons/css/themify-icons.css' />">
	</head>
			...
			<table class="table">
				...
				<tbody>
					<c:forEach var="u" items="${listProduct}">
						<tr>
							<td><img src="${u.getProductImage() }" alt="Product Image" class="product-image mr-2" />
