  ...
  <body>
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6">
          <img
            src="${listProduct.get(0).getProductImage() }" alt="Product Image" class="img-fluid" style="margin-top: 10px";
            alt="Product Image"
            class="img-fluid"
          />
        </div>
        <div class="col-lg-6">
          <h1>${listProduct.get(0).getName()}</h1>
          <p>Price: $999</p>
          <div class="mb-3">
        ...
        <div class="row" style="margin-top: 20px;">
          <div class="item" style="border-radius: 10px;">
            <div class="item-icon"><i class="fas fa-laptop"></i></div>
            <div class="item-title">100% Original</div>
            <div class="item-subtitle">Chocolate bar candy canes ice cream toffee cookie halvah.</div>
          </div>
          <div class="item" style="border-radius: 10px;">
            <div class="item-icon"><i class="fas fa-mobile-alt"></i></div>
            <div class="item-title">10 Day Replacement</div>
            <div class="item-subtitle">Marshmallow biscuit donut dragée fruitcake wafer.</div>
          </div>
          <div class="item" style="border-radius: 10px;">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6">
                <h3>Description</h3>
                <p>
                  ${listProduct.get(0).getDescription() }
                </p>
              </div>
            </div>
            <hr />
