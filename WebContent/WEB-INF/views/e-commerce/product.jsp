		...
		<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
				...
				<head>
					...
					<link rel="stylesheet" href="<c:url value ='/common/assets/css/layout/sidebar.css' />">
					<link rel="stylesheet" href="<c:url value ='/common/assets/css/reset.css' />">
					<link rel="stylesheet"
				...
				<body>
											...
											<div class="variation-layout">
												...
												<div class="flex-column">
														...
														<div class="variation-radio">
															<c:forEach items="${listConfigProduct}" var="element">
																<span class="variation-radio-input"> <input
																		name="productItemId" type="radio" value="#000"
																		<c:if
													...
													<div class="variation-wrapper">
														...
														<div class="variation-select-quantity">
															<div name="quantity" class="quantity">
																<button class="quantity-button" tabindex="-1"
																	type="button">
																...
																<button class="quantity-button" tabindex="0"
																	type="button">
																	<svg xmlns="http://www.w3.org/2000/svg"
																		xmlns:xlink="http://www.w3.org/1999/xlink"
																		aria-hidden="true" role="img"
															...
															<div class="quantity-title">
																Sản phẩm sẵn có: <span
																	class="current-product">${currentProductItem.quantityInStock
																	}</span>
															</div>
														</div>
													</div>
													...
													<div class="button-group">
														<button class="button--add-to-cart" tabindex="0" type="button">
															<span
								...
								<div class="promise-container">
									<div class="promise-item">
										<div class="item-icon">
											<svg xmlns="http://www.w3.org/2000/svg"
												...
												class="MuiBox-root icon iconify iconify--ic" width="1em" height="1em"
												viewBox="0 0 24 24">
												<path fill="currentColor"
									...
									<div class="promise-item">
										<div class="item-icon">
											<svg xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
												class="MuiBox-root icon iconify iconify--eva" width="1em" height="1em"
												viewBox="0 0 24 24">
										...
										<p class="promise-description">Chính sách đổi trả trong vòng 10
											ngày đầu tiên</p>
									</div>
									<div class="promise-item">
										<div class="item-icon">
									...
									<div class="description-tab">
										...
										<div class="description-tab-wrapper" style="margin-bottom: 0px;">
											<div class="tab-group" role="tablist">
												...
												<button class="tab-button" tabindex="-1" type="button" role="tab"
													aria-selected="false">
													Reviews (<span>8</span>)
												</button>
											</div>
					...
					<script type="text/javascript" src="<c:url value='/common/assets/js/navbar.js'/>"></script>
					<script type="text/javascript">
						...
						// Set initial positions of the line element
						...
						// Function to switch to the description tab
						function switchToDescriptionTab() {
							// ...
							// Move the line element to the description tab button
						...
						// Function to switch to the reviews tab
						function switchToReviewsTab() {
							// ...
							// Move the line element to the reviews tab button
